...
public struct DataDeltaProto : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_2_0_0(); }
  public static DataDeltaProto GetRootAsDataDeltaProto(ByteBuffer _bb) { return GetRootAsDataDeltaProto(_bb, new DataDeltaProto()); }
  public static DataDeltaProto GetRootAsDataDeltaProto(ByteBuffer _bb, DataDeltaProto obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public DataDeltaProto __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public string DeletedProperties(int j) { int o = __p.__offset(14); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int DeletedPropertiesLength { get { int o = __p.__offset(14); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<DataDeltaProto> CreateDataDeltaProto(FlatBufferBuilder builder,
      ushort class_id = 0,
    ...
    DataDeltaProto.AddObjectVersion(builder, object_version);
    DataDeltaProto.AddDeletedProperties(builder, deleted_propertiesOffset);
    DataDeltaProto.AddProperties(builder, propertiesOffset);
    DataDeltaProto.AddPrimaryKey(builder, primary_keyOffset);
    DataDeltaProto.AddClassId(builder, class_id);
    DataDeltaProto.AddDeleted(builder, deleted);
    return DataDeltaProto.EndDataDeltaProto(builder);
  }

  public static void StartDataDeltaProto(FlatBufferBuilder builder) { builder.StartTable(6); }
  ...
  public static void AddDeletedProperties(FlatBufferBuilder builder, VectorOffset deletedPropertiesOffset) { builder.AddOffset(5, deletedPropertiesOffset.Value, 0); }
  ...
  public static Offset<DataDeltaProto> EndDataDeltaProto(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    builder.Required(o, 8);  // primary_key
    return new Offset<DataDeltaProto>(o);
  }
};
