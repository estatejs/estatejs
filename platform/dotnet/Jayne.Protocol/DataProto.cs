...
public struct DataProto : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_2_0_0(); }
  public static DataProto GetRootAsDataProto(ByteBuffer _bb) { return GetRootAsDataProto(_bb, new DataProto()); }
  public static DataProto GetRootAsDataProto(ByteBuffer _bb, DataProto obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public DataProto __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public PropertyProto? Properties(int j) { int o = __p.__offset(12); return o != 0 ? (PropertyProto?)(new PropertyProto()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int PropertiesLength { get { int o = __p.__offset(12); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<DataProto> CreateDataProto(FlatBufferBuilder builder,
      ushort class_id = 0,
    ...
    DataProto.AddObjectVersion(builder, object_version);
    DataProto.AddProperties(builder, propertiesOffset);
    DataProto.AddPrimaryKey(builder, primary_keyOffset);
    DataProto.AddClassId(builder, class_id);
    DataProto.AddDeleted(builder, deleted);
    return DataProto.EndDataProto(builder);
  }

  public static void StartDataProto(FlatBufferBuilder builder) { builder.StartTable(5); }
  ...
  public static Offset<DataProto> EndDataProto(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    builder.Required(o, 8);  // primary_key
    return new Offset<DataProto>(o);
  }
};
