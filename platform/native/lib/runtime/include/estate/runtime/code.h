...
#define GET_CODE_VALUE(c) (CodeV)(c)

namespace estate {
    using CodeV = u16;
    enum class Code : CodeV {
        Unimplemented = 0,
        Ok = 1,
        InvalidRequest = 2,
        InvalidLogContext = 3,
        ...
        Datastore_ObjectInstanceCorrupted = 27,
        Datastore_ObjectPropertiesIndexCorrupted = 28,
        Datastore_ClientHasVersionInvalid = 29,
        Datastore_WorkerIndexCorrupted = 30,
        Datastore_MustGetLatestWorker = 31,
        Datastore_EngineSourceCorrupted = 32,
        Datastore_WorkerIndexNotFound = 33,
        ...
        Datastore_WorkerVersionCorrupted = 40,
        Datastore_FailedToSetInitialWorkerVersion = 41,
        WorkerAuthentication_UserKeyNotFound = 42,
        WorkerAuthentication_InvalidValueFound = 43,
        ...
        InnerspaceClientConnection_UnexpectedSendThreadAlreadyRunning = 50,
        InnerspaceClientConnection_UnexpectedRecvThreadAlreadyRunning = 51,
        ...
        Innerspace_TooManyEndpoints = 57,
        Launcher_TimedOutWhileGettingWorkerProcess = 58,
        Launcher_FailedToSpawnWorkerProcess = 59,
        WorkerProcess_WrongWorkerId = 60,
        WorkerProcess_WorkerDeleted = 61
    };

    inline const char* get_code_name(Code c) {
        switch (c) {
            ...
            case Code::Datastore_WorkerIndexCorrupted:
                return "Datastore_WorkerIndexCorrupted";
            case Code::Datastore_MustGetLatestWorker:
                return "Datastore_MustGetLatestWorker";
            case Code::Datastore_EngineSourceCorrupted:
                return "Datastore_EngineSourceCorrupted";
            case Code::Datastore_WorkerIndexNotFound:
                return "Datastore_WorkerIndexNotFound";
            ...
            case Code::Datastore_WorkerVersionCorrupted:
                return "Datastore_WorkerVersionCorrupted";
            case Code::Datastore_FailedToSetInitialWorkerVersion:
                return "Datastore_FailedToSetInitialWorkerVersion";
            case Code::WorkerAuthentication_UserKeyNotFound:
                return "WorkerAuthentication_UserKeyNotFound";
            case Code::WorkerAuthentication_InvalidValueFound:
                return "WorkerAuthentication_InvalidValueFound";
            ...
            case Code::InnerspaceClientConnection_UnexpectedSendThreadAlreadyRunning:
                return "InnerspaceClientConnection_UnexpectedSendThreadAlreadyRunning";
            case Code::InnerspaceClientConnection_UnexpectedRecvThreadAlreadyRunning:
                return "InnerspaceClientConnection_UnexpectedRecvThreadAlreadyRunning";
            ...
            case Code::Innerspace_TooManyEndpoints:
                return "Innerspace_TooManyEndpoints";
            case Code::Launcher_TimedOutWhileGettingWorkerProcess:
                return "Launcher_TimedOutWhileGettingWorkerProcess";
            case Code::Launcher_FailedToSpawnWorkerProcess:
                return "Launcher_FailedToSpawnWorkerProcess";
            case Code::WorkerProcess_WrongWorkerId:
                return "WorkerProcess_WrongWorkerId";
            case Code::WorkerProcess_WorkerDeleted:
                return "WorkerProcess_WorkerDeleted";
            default:
