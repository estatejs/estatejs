...
export enum WorkerReferenceUnionProto{
  NONE = 0,
  DataReferenceValueProto = 1,
  ServiceReferenceValueProto = 2
}

export function unionToWorkerReferenceUnionProto(
  type: WorkerReferenceUnionProto,
  ...
  switch(WorkerReferenceUnionProto[type]) {
...
export function unionListToWorkerReferenceUnionProto(
  type: WorkerReferenceUnionProto, 
