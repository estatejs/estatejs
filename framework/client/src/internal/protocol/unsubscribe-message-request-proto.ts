...
static createUnsubscribeMessageRequestProto(builder:flatbuffers.Builder, classId:number, sourceType:WorkerReferenceUnionProto, sourceOffset:flatbuffers.Offset):flatbuffers.Offset {
