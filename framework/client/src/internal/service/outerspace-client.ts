...
export class OuterspaceClient {
    ...
    private onMessage = (message: any) => {
        if (!message.data) {
            throw new Error(sysLogError("Empty message received from Estate"));
        } else {
            if (message.data instanceof ArrayBuffer) {
                ...
                switch (sendKind) {
                    case SendKind.Invalid:
                        throw new Error(sysLogError("Invalid message received from Estate: invalid SendKind value"));
                    ...
                    case SendKind.Message:
                        ...
                        break;
                    default:
                        throw new Error(sysLogError("Invalid message received from Estate: unknown SendKind value"));
                }
            } else {
                throw new Error(sysLogError("Invalid message received from Estate"));
            }
        }
    };
