...
import { Exercise, ExerciseTrackerService } from 'MY-WORKER-NAME-worker';
...
class EditExercise extends Component {
    ...
    async componentDidMount() {
        try {
            ...
            const exercise = await worker.getDataAsync(Exercise, this.props.id);
    ...
    async onSubmit(e) {
        ...
        try {
            ...
            //Save the exercise
            await worker.saveDataAsync(exercise);
